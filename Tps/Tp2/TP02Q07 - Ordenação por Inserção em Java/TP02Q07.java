                    ...
                    if (z==0) {
                        ...
                        if (personagens1.get(menor).getName().charAt(0) > personagens1.get(j).getName().charAt(0)) {
                            ...
                            if (personagens1.get(menor).getName().charAt(0) == personagens1.get(j).getName().charAt(0)
                                ...
                                comp += 3;
                                if (personagens1.get(menor).getName().charAt(0) == personagens1.get(j).getName()
                                        .charAt(0) &&
                                        personagens1.get(menor).getName().charAt(1) == personagens1.get(j).getName()
                                                .charAt(1)
                                        &&
                                        personagens1.get(menor).getName().charAt(2) > personagens1.get(j).getName()
                                                .charAt(2)) {
                                    menor = j;
                                } else {
                                    comp += 4;
                                    if (personagens1
                                            .get(menor).getName().charAt(0) == personagens1.get(j).getName().charAt(0)
                                            &&
                                            personagens1.get(menor).getName().charAt(1) == personagens1.get(j).getName()
                                                    .charAt(1)
                                            &&
                                            personagens1.get(menor).getName().charAt(2) == personagens1.get(j).getName()
                                                    .charAt(2)
                                            &&
                                            personagens1.get(menor).getName().charAt(3) > personagens1.get(j).getName()
                                                    .charAt(3)) {
                                        menor = j;
                                    }
                                }
